...
export const products = [
  ...
  },
  {
    ...
    description:
      "Función:\n• Filtración o tamizado de sólidos (separación sólido-líquido).\n• Eliminación de sólidos finos con tamaño mayores.\n• Autolimpiante.\n\nLos pretratamientos están diseñados principalmente para aguas residuales urbanas típicas. Para vertidos industriales u otros usos.\n\nCaracterísticas:\n• Fabricado en acero inoxidable AISI 304, con cilindro filtrante en AISI 304, motor reductor 400 V 50 Hz, incluido válvula de mariposa, electroválvulas agua de red. Tomas bridadas fabricadas en AISI 304 o roscable.\n\nAccesorios:\n• Electroválvula para el paso de agua de limpieza.\n• Filtro Y.\n• Válvula de bola.",
    category: "Tratamiento de Aguas",
    badge: "Autolimpiante",
    icon: "⚙️",
    keywords: [
      "tamiz rotativo Paraguay",
      "tamiz autolimpiante aguas residuales",
      "pretratamiento aguas residuales Paraguay",
      "tamiz inoxidable AISI 304",
      "separador sólidos líquidos Paraguay",
    ],
    metaDescription:
      "Tamiz rotativo autolimpiante en Paraguay. METSIM fabrica tamices en acero inoxidable AISI 304 para pretratamiento de aguas residuales urbanas e industriales. Cotizá en 24 horas.",
    specs: [
      { label: "Material", value: "AISI 304 / AISI 316" },
      { label: "Diámetro", value: "250 – 1000 mm" },
      { label: "Longitud", value: "Personalizable" },
      { label: "Apertura de malla", value: "3 – 20 mm" },
    ...
    applications: [
      ...
      "Filtración de sólidos en línea",
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/floculadores/floculador-tubular-4.png", label: "Floculador Tubular — instalación completa" },
    ],
    modelPoster: null,
  },
  {
    ...
    images: [
      { src: "/images/mezcladores/mezclador-estatico-1.png", label: "Mezclador Estático — METSIM Solutions" },
      ...
      { src: "/images/mezcladores/mezclador-estatico-4.png", label: "Mezclador Estático — instalación en campo" },
    ],
    modelPoster: null,
  },
];
